...
{
  switch(err) {
  case EDEADLK: log::msg()->error("posix_thread::dump_err -> EDEADLK"); break;
  case EINVAL: log::msg()->error("posix_thread::dump_err -> EINVAL"); break;
  case ESRCH: log::msg()->error("posix_thread::dump_err -> ESRCH"); break;
  default: log::msg()->error("posix_thread::dump_err -> unknown"); break;
  }
}
